!(function (e, t) {
    ...
    if (!r && (Oe(t), (t = t || E), k)) {
      ...
      if (!(de[e + " "] || (p && p.test(e)))) {
        if (((l = e), (c = t), 1 === f && (xe.test(e) || ve.test(e)))) {
          for (
            ((c = (ke.test(e) && He(t.parentNode)) || t) == t && g.scope) ||
              ((s = t.getAttribute("id"))
  ...
  function De() {
    ...
    return function e(t, n) {
      return (
        r.push(t + " ") > w.cacheLength && delete e[r.shift()], (e[t + " "] = n)
      );
    };
  }
  function q(e) {
  ...
  function _e(e, t, n, r) {
    ...
    return (
      (l || Be(e, c))(r, t, !k, n, !t || (ke.test(e) && He(t.parentNode)) || t),
      n
    );
  }
  ...
  (S.filter = function (e, t, n) {
    ...
    S.fn.extend({
      ...
      is: function (e) {
        return !!Ge(
          this,
          "string" == typeof e && Ue.test(e) ? S(e) : e || [],
          !1
        ).length;
      },
    });
  ...
  (S.Callbacks = function (r) {
    ...
    S.extend({
                  ...
                  function e() {
                    ...
                    if (!(i < u)) {
                      ...
                      (t =
                        ...
                        v(t)
                          ? a
                            ? t.call(e, l(u, o, et, a), l(u, o, tt, a))
                            : (u++,
                              t.call(
                                e,
                                l(u, o, et, a),
                                l(u, o, tt, a),
                                l(u, o, et, o.notifyWith)
                              ))
                          : (s !== et && ((n = void 0), (r = [e])),
                            (a || o.resolveWith)(n, r));
                    }
      ...
      when: function (e) {
        ...
        if (
          n <= 1 &&
          (nt(e, s.done(t(r)).resolve, s.reject, !n),
          "pending" === s.state() || v(o[r] && o[r].then))
        )
          return s.then();
        for (; r--; ) nt(o[r], t(r), s.reject);
        return s.promise();
      },
    });
  ...
  (S.fn.ready = function (e) {
    ...
    ("loading" !== C.readyState && !C.documentElement.doScroll)
      ...
      : (C.addEventListener("DOMContentLoaded", ot),
  ...
  function dt(e, t, n) {
    ...
    if (void 0 === n && 1 === e.nodeType)
      if (
        ((r = "data-" + t.replace(pt, "-$&").toLowerCase()),
  ...
  function ht(e, t) {
    return (
      ...
      ("" === e.style.display && vt(e) && "none" === S.css(e, "display"))
    );
  }
  ...
  mt.getRootNode &&
    (vt = function (e) {
      return (
        S.contains(e.ownerDocument, e) || e.getRootNode(xt) === e.ownerDocument
      );
    });
  function bt(e, t, n, r) {
    var i,
    ...
    for (var n, r, i, o, s, a, u = [], l = 0, c = e.length; l < c; l++)
      (r = e[l]).style &&
        ...
        t
          ...
          : "none" !== n && ((u[l] = "none"), m.set(r, "display", n)));
  ...
  function At(e, t, n, r, i) {
    ...
    for (c.textContent = "", p = 0; (o = f[p++]); )
      if (r && -1 < S.inArray(o, r)) i && i.push(o);
        ...
        ((u = vt(o)), (s = y(c.appendChild(o), "script")), u && kt(s), n)
      )
        ...
        S.event.add(e, r, {
          ...
          handler: function (e) {
            ...
            if (1 & e.isTrigger && this[r]) {
              ...
              n &&
                (m.set(this, r, S.event.trigger(n[0], n.slice(1), this)),
                e.stopPropagation(),
  ...
  (S.event = {
    ...
    dispatch: function (e) {
      ...
      if (
        ...
        for (
          o = S.event.handlers.call(this, a, e), t = 0;
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          e = this || e;
          return (
            Ct.test(e.type) && e.click && b(e, "input") && Ht(e, "click", !0),
            !1
          );
        },
        trigger: function (e) {
    ...
    S.each({ focus: "focusin", blur: "focusout" }, function (r, i) {
      function o(e) {
        var t, n;
        C.documentMode
          ? ((t = m.get(this, "handle")),
  ...
  function $t(n, r, i, o) {
    ...
    if (
      f &&
      ((t = (e = At(r, n[0].ownerDocument, !1, n, o)).firstChild),
      ...
      for (a = (s = S.map(y(e, "script"), It)).length; c < f; c++)
        (u = e),
          c !== p &&
            ((u = S.clone(u, !0, !0)), a) &&
            S.merge(s, y(u, "script")),
          i.call(n[c], u, c);
      if (a)
        for (l = s[s.length - 1].ownerDocument, S.map(s, Wt), c = 0; c < a; c++)
          (u = s[c]),
            Et.test(u.type || "") &&
              ...
              (u.src && "module" !== (u.type || "").toLowerCase()
                ...
                : V(u.textContent.replace(Mt, ""), u, l));
    }
    return n;
  }
  function Bt(e, t, n) {
    for (var r, i = t ? S.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
      n || 1 !== r.nodeType || S.cleanData(y(r)),
        r.parentNode &&
          (n && vt(r) && kt(y(r, "script")), r.parentNode.removeChild(r));
    return e;
  }
  S.extend({
    ...
    S.fn.extend({
      ...
      empty: function () {
        for (var e, t = 0; null != (e = this[t]); t++)
          1 === e.nodeType && (S.cleanData(y(e, !1)), (e.textContent = ""));
        return this;
      },
      clone: function (e, t) {
        return (
          ...
          function (e) {
            ...
            if (
              ...
              try {
                for (; n < r; n++)
                  1 === (t = this[n] || {}).nodeType &&
                    (S.cleanData(y(t, !1)), (t.innerHTML = e));
                t = 0;
              } catch (e) {}
            }
  ...
  function hn(e, t, n, r, i, o) {
    ...
    for (; s < 4; s += 2)
      "margin" === n && (l += S.css(e, n + yt[s], !0, i)),
        r
          ? ("content" === n && (u -= S.css(e, "padding" + yt[s], !0, i)),
            "margin" !== n &&
              (u -= S.css(e, "border" + yt[s] + "Width", !0, i)))
          : ((u += S.css(e, "padding" + yt[s], !0, i)),
            "padding" !== n
              ? (u += S.css(e, "border" + yt[s] + "Width", !0, i))
              : (a += S.css(e, "border" + yt[s] + "Width", !0, i)));
    return (
      !r &&
        0 <= o &&
        (u +=
  ...
  function gn(e, t, n) {
    ...
    return (
      ((!g.boxSizingReliable() && i) ||
        ...
        ((i = "border-box" === S.css(e, "boxSizing", !1, r)), (o = a in e)) &&
        (s = e[a]),
      (s = parseFloat(s) || 0) +
        hn(e, t, n || (i ? "border" : "content"), o, r, s) +
        "px"
    );
  }
  ...
  S.extend({
    ...
    style: function (e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var i,
          ...
          l = e.style;
        if (
          (u || (t = ln(a)), (s = S.cssHooks[t] || S.cssHooks[a]), void 0 === n)
        )
    ...
    S.each(["height", "width"], function (e, s) {
      S.cssHooks[s] = {
        get: function (e, t, n) {
          if (t)
            return !cn.test(S.css(e, "display")) ||
      ...
      _default: {
        ...
        set: function (e) {
          S.fx.step[e.prop]
            ? S.fx.step[e.prop](e)
            : 1 !== e.elem.nodeType ||
              (!S.cssHooks[e.prop] && null == e.elem.style[ln(e.prop)])
            ? (e.elem[e.prop] = e.now)
  ...
  function P(i, e, t) {
    ...
    return (
      ...
      S.fx.timer(S.extend(d, { elem: i, anim: h, queue: h.opts.queue })),
      h
    );
  }
  (S.Animation = S.extend(P, {
    ...
    tweener: function (e, t) {
      for (
        var n, r = 0, i = (e = v(e) ? ((t = e), ["*"]) : e.match(L)).length;
        r < i;
        r++
      )
        (n = e[r]),
        ...
        if ((u = !S.isEmptyObject(t)) || !S.isEmptyObject(p))
          ...
          p))
            u ||
              ...
              h && Tt([e], !0),
              f.done(function () {
                for (r in (h || Tt([e]), m.remove(e, "fxshow"), p))
                  S.style(e, r, p[r]);
              })),
              (u = Cn(h ? g[r] : 0, r, f)),
              r in g ||
      ...
      stop: function (i, e, o) {
        ...
        return (
          ...
          this.each(function () {
            ...
            else for (t in r) r[t] && r[t].stop && xn.test(t) && s(r[t]);
            for (t = n.length; t--; )
              n[t].elem !== this ||
                (null != i && n[t].queue !== i) ||
      ...
      propHooks: {
        tabIndex: {
          get: function (e) {
            ...
            return t
              ? parseInt(t, 10)
              : kn.test(e.nodeName) || (jn.test(e.nodeName) && e.href)
              ? 0
              : -1;
          },
        },
    ...
    S.fn.extend({
      addClass: function (t) {
        ...
        return v(t)
          ...
          ? this.each(function () {
              if (
                ((r = Dn(this)), (n = 1 === this.nodeType && " " + An(r) + " "))
              ) {
          ...
          : ((e = Nn(t)),
            this.each(function () {
              if (a)
                ...
                (void 0 !== t && "boolean" != s) ||
                  ((r = Dn(this)) && m.set(this, "__className__", r),
                  this.setAttribute &&
                    this.setAttribute(
                      "class",
      ...
      (S.extend(S.event, {
        trigger: function (e, t, n, r) {
          ...
          if (
            ...
            if (!r && !l.noBubble && !R(n)) {
              for (
                s = l.delegateType || p, Mn.test(s + p) || (h = h.parentNode);
                h;
                h = h.parentNode
              )
                f.push(h), (o = h);
        ...
        simulate: function (e, t, n) {
          n = S.extend(new S.Event(), n, { type: e, isSimulated: !0 });
        ...
        return this.map(function () {
          ...
          .map(function (e, t) {
            ...
            return null == n
              ...
              : Array.isArray(n)
              ? S.map(n, function (e) {
                  return { name: t.name, value: e.replace(In, "\r\n") };
                })
        ...
        if (
          ...
          try {
            (i.href = h.url),
              (i.href = i.href),
              (h.crossDomain =
                Qn.protocol + "//" + Qn.host != i.protocol + "//" + i.host);
          } catch (e) {
            h.crossDomain = !0;
          }
        }
        if (
          ...
          h.hasContent
            ? h.data &&
              ...
              (h.data = h.data.replace($n, "+"))
            : ((i = h.url.slice(l.length)),
              h.data &&
                (h.processData || "string" == typeof h.data) &&
                ((l += (Pn.test(l) ? "&" : "?") + h.data), delete h.data),
              !1 === h.cache &&
                ((l = l.replace(_n, "$1")),
          ...
          h.ifModified &&
            (S.lastModified[l] &&
              b.setRequestHeader("If-Modified-Since", S.lastModified[l]),
            S.etag[l]) &&
    ...
    ir =
      ...
      S.ajaxPrefilter("json jsonp", function (e, t, n) {
        ...
        if (s || "jsonp" === e.dataTypes[0])
          return (
            ...
            s
              ? (e[s] = e[s].replace(rr, "$1" + r))
              : !1 !== e.jsonp &&
                (e.url += (Pn.test(e.url) ? "&" : "?") + e.jsonp + "=" + r),
            ...
            n.always(function () {
              void 0 === i ? S(T).removeProp(r) : (T[r] = i),
                e[r] && ((e.jsonpCallback = t.jsonpCallback), nr.push(r)),
                o && v(i) && i(o[0]),
                (o = i = void 0);
            }),
            "script"
      ...
      (S.fn.load = function (e, t, n) {
        var r,
          ...
          a = e.indexOf(" ");
        return (
          -1 < a && ((r = An(e.slice(a))), (e = e.slice(0, a))),
          v(t)
            ? ((n = t), (t = void 0))
      ...
      (S.offset = {
        setOffset: function (e, t, n) {
          ...
          "static" === a && (e.style.position = "relative"),
            ...
            null != (t = v(t) ? t.call(e, n, S.extend({}, o)) : t).top &&
              (l.top = t.top - o.top + i),
      ...
      S.each(["top", "left"], function (e, n) {
        S.cssHooks[n] = nn(g.pixelPosition, function (e, t) {
          if (t)
            return (t = tn(e, n)), Kt.test(t) ? S(e).position()[n] + "px" : t;
        });
      }),
  ...
  return (
    (S.noConflict = function (e) {
      return T.$ === S && (T.$ = sr), e && T.jQuery === S && (T.jQuery = or), S;
    }),
